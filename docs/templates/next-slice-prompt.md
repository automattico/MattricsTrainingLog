...
Goal:
<one concrete outcome for this slice>

Context:
<brief summary of completed slices and current repo state>
...
- If credential state is needed, expose only boolean/status metadata.
