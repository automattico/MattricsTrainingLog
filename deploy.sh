...

{
  ...
  printf '%s\n' "mkdir \"$SFTP_REMOTE_PRIVATE_DIR/data\""
  printf '%s\n' "mkdir \"$SFTP_REMOTE_APP_PRIVATE_DIR\""
  printf '%s\n' "mkdir \"$SFTP_REMOTE_APP_PRIVATE_DIR/data\""
  ...
  printf '%s\n' "mirror --reverse --only-missing --verbose private/data \"$SFTP_REMOTE_PRIVATE_DIR/data\""
  printf '%s\n' "mirror --reverse --only-missing --verbose private/data \"$SFTP_REMOTE_APP_PRIVATE_DIR/data\""
  printf '%s\n' "set cmd:fail-exit no"
